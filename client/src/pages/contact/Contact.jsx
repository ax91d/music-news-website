    ...
    >
      <div className="contact-wrap">
        ...
        <p className="contact-text">
          Our mission is to stand up to the community of people interested in
          all things music and to cover important industry events. We are
          constantly evolving and welcome exceptional communication, any ideas
